...
# ✅ Функция за анимация с точки (работи във фонов процес)
animate_dots() {
  while true; do
    printf "."
    sleep 0.3
    # Принудително извеждане (избягва буфериране)
    echo -n "" >&2
  done
}

# ✅ Стартираме анимацията за извличане
...
# ✅ Мини-анимация преди избора на IP (бърза)
