...
# ✅ Стартиране на анимацията във фонов процес
echo -n "🔍 Извличане на VPN подмрежата"
animate_dots &
ANIM_PID=$!
...
# ✅ Спиране на анимацията и нов ред
...
# ✅ Мини-анимация преди избора на IP (без излишно забавяне)
