...
echo "✅ Проверки завършени успешно."
echo ""
exit 0
# =====================================================================
...
while true; do
  ...
  if [[ -d "$CLIENT_DIR" ]]; then
    ...
    case "$choice" in
      [Yy]*) echo "▶ Презапис на конфигурацията..."; rm -rf "$CLIENT_DIR"; break ;;
      [Qq]*) echo "❎ Прекратяване на скрипта."; exit 0 ;;
      *) echo "❌ Невалиден избор. Въведете 'y' или 'q'."; continue ;;
    esac
  else
    break
  fi
