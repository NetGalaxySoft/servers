...
### Етап 4 - Създаване на системата за архивиране на данни
...
**Следваща стъпка:** Преминаване към следващия етап от разработката на backup механизма съгласно проектния план.
...
| **Стъпка 11**       | Конфигуриране на бърза SSH връзка `s1-backup`        | **Level B** |       10       |
...
| :------------------------------------------- | :------------: | :----------: | :----------------: | :----------: |
| **I. Базова структура и графични операции**  |   **Level C**  |    **10**    |     **100.00**     |   **16.67**  |
| **II. Конфигурация, Tailscale, SSH и отчет** |   **Level B**  |    **55**    |     **150.00**     |  **137.50**  |
| **III. Synology сигурност и достъп**         |   **Level A**  |    **50**    |     **250.00**     |  **208.33**  |
| **ОБЩО ЗА ПРОТОКОЛА:**                       |                | **115 мин.** | **Средна: 188.70** | **362.50 €** |

### ДАННИ ЗА СМАРТ КОНТРАКТ (SMART CONTRACT PAYOUT)

* **ID на задачата:** NG-D2-INSTALL-P4
* **Валута на изчисление:** EUR / NetGalaxy Token (NGT)
* **Обща стойност:** **362.50 €**
* **Разпределение:**
