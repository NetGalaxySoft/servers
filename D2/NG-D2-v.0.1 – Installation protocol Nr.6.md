...
### Етап 5 - Автоматизиране на системата за архивиране на данни
...
## Етап 4, Стъпка 1: Дефиниране на параметрите в конфигурационния файл
...
## Етап 4, Стъпка 2: Създаване на скрипта за архивиране (backup engine)
...
## Етап 4, Стъпка 3: Ръчно тестване на backup engine (първо изпълнение)
...
## Етап 4, Стъпка 4: Проверка на наличния архив на S1
...
## Етап 4, Стъпка 5: Създаване на скрипт за извличане на архив към директорията /restore 
...
## Етап 4, Стъпка 6: Тестване на restore-fetch скрипта
...
## Етап 4, Стъпка 7: Създаване на cleanup скрипт
...
## Етап 4, Стъпка 8: Ръчно тестване на cleanup скрипта
...
## Етап 4, Стъпка 9: Конфигуриране на автоматично изпълнение чрез cron
...
## Етап 4, Стъпка 10: Тестване на ротацията (cleanup с реален стар файл)
...
## Етап 4, Стъпка 11: Тестване на cron (симулация)
...
**Следваща стъпка:** Преминаване към следващия етап от инфраструктурната автоматизация съгласно проектния план.
...
| **Стъпка 10**       | Тестване на ротацията с реален стар файл          | **Level A** |       10       |
...
| :---------------------------------------- | :------------: | :----------: | :----------------: | :----------: |
| **I. Проверки и runtime операции**        |   **Level B**  |    **55**    |     **150.00**     |  **137.50**  |
| **II. Сигурна backup логика и retention** |   **Level A**  |    **60**    |     **250.00**     |  **250.00**  |
