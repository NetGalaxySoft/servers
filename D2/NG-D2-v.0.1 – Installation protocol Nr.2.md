...
Перфектно — точно така трябва да изглеждат стъпките 👍
Ето ти **Стъпка 3**, написана по същия стил и отразяваща реално какво направихме:
...
---
## Етап 2, Стъпка 17: Настройка на логовата ротация
...
## Етап 2, Стъпка 18: Проверка на хостинга (PASS)
...
| **Стъпка 17**       | Настройка на logrotate                              | **Level B** |       10       |
| **Стъпка 18**       | Финална PASS проверка на хостинга                   | **Level C** |        5       |
