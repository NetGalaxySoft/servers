...
# =====================================================================
if [[ $EUID -ne 0 ]]; then
  echo "🛑 Скриптът трябва да се изпълнява с root права (използвайте sudo)."
  echo "Пример:"
  echo "  sudo ./vps-dns-secure.sh"
  exit 1
fi

# =====================================================================
# Проверка за наличието на setup.env
# =====================================================================
if ! sudo test -f "$SETUP_ENV_FILE"; then
  echo "❌ Липсва файлът $SETUP_ENV_FILE."
  echo "ℹ️ Уверете се, че сте изпълнили скрипта vps-dns-qsetup.sh успешно."
  exit 1
fi
