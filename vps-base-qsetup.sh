...
while true; do
  printf "👉 Въведете потребителско име за новия администратор (мин. 8 символа или q за изход): "
  read ADMIN_USER
...
while true; do
  printf "🔑 Въведете парола за $ADMIN_USER (мин. 8 символа): "
  read -s PASSWORD_1
  echo
