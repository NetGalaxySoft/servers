...
if [[ "$FIREWALL_SYSTEM" == "ufw" ]]; then
  ...
  if [[ "$FIREWALL_SYSTEM" == "none" ]]; then
    ...
    # Опит за извличане на отворени портове с универсален подход
...
# --- [4.1] ИНФОРМАЦИЯ ЗА ИЗПОЛЗВАНЕ НА UFW ----------------------------------------
echo "[4.1] ИНФОРМАЦИЯ ЗА ИЗПОЛЗВАНЕ НА UFW..."
echo "-------------------------------------------------------------------------"
echo ""
...
echo "[4.2] ВЪВЕЖДАНЕ НА ДОПЪЛНИТЕЛНИ FIREWALL ПОРТОВЕ..."
echo "-------------------------------------------------------------------------"
echo ""
...
if [[ "$FIREWALL_SYSTEM" != "none" ]]; then
  ...
  # 🔐 Показване на SSH порта – ПРЕДИ диалога за нови портове
  if [[ -n "$SSH_PORT" ]]; then
    echo ""
