...
# Потвърждение дали скриптът се счита за успешно завършен
echo ""
read -p "📋 Приемате ли скрипта като напълно изпълнен и успешен? (y / n): " final_confirm
...
while true; do
  ...
  case "$restart_choice" in
    ...
    [Qq]*)
      ...
      ;;
    "")
      echo "✅ Скриптът завърши успешно. Няма рестарт."
      break
      ;;
    *)
